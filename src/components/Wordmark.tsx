...
/**
 * Cardboard-arcade wordmark for Songtiles. Each letter is its own little
...
const LETTERS: Array<{ ch: string; tilt: number; bg: string; fg: string }> = [
  { ch: 'S', tilt: -3,  bg: '#ff5b4a', fg: '#fff8eb' },  // tomato red
  { ch: 'O', tilt:  2,  bg: '#ffb454', fg: '#2a2826' },  // amber
  { ch: 'N', tilt: -2,  bg: '#7ed957', fg: '#2a2826' },  // lime
  { ch: 'G', tilt:  3,  bg: '#4cc9f0', fg: '#0e1421' },  // sky
  { ch: 'T', tilt: -1.5, bg: '#a06cd5', fg: '#fff8eb' }, // violet
  { ch: 'I', tilt:  2.5, bg: '#ff8fab', fg: '#2a2826' }, // pink
  { ch: 'L', tilt: -2.5, bg: '#ffd166', fg: '#2a2826' }, // butter
  { ch: 'E', tilt:  1.5, bg: '#06d6a0', fg: '#0e1421' }, // mint
  { ch: 'S', tilt: -3,  bg: '#ef476f', fg: '#fff8eb' }, // raspberry
];
      ...
      {LETTERS.map((l, i) => (
        <span
          ...
          style={{
            ...
            border: `2px solid ${tokens === tokens ? 'var(--chunky-edge)' : '#2a2826'}`,
